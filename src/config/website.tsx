...
export const websiteConfig: WebsiteConfig = {
  ...
  metadata: {
    images: {
      ogImage: '/kingdomchronicle/key-art.jpg',
      logoLight: '/logo.svg',
      logoDark: '/logo.svg',
    },
    social: {
      github: '',
      twitter: 'https://x.com/hakubyousai',
      blueSky: '',
      discord: '',
      mastodon: '',
      linkedin: '',
      youtube: 'https://www.youtube.com/channel/UCLtdqnLtpp_FGQFaLK7GxQg',
    },
  },
  features: {
  ...
  mail: {
    provider: 'resend',
    fromEmail: 'Kingdom Chronicle Wiki <hello@kingdomchronicle.wiki>',
