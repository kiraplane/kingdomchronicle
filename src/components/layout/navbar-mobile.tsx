        ...
        <div className="ml-2 flex shrink-0 items-center justify-end">
          <Button
            ...
            className="size-8 flex aspect-square h-fit cursor-pointer select-none items-center
              justify-center rounded-md border border-[#4a382a] text-[#f6ead1] hover:border-[#f2c86b] hover:bg-[#1d1712]"
          >
            {open ? (
...
function MainMobileMenu({ onLinkClicked }: MainMobileMenuProps) {
  ...
  return (
    <div
      ...
      border-[#4a382a] border-t bg-[#0d0a08] text-[#f6ead1] backdrop-blur-md animate-in fade-in-0"
    >
      <div className="size-full flex flex-col items-start space-y-4 pt-4">
                ...
                {item.items ? (
                    ...
                    <CollapsibleTrigger asChild>
                      <Button
                        ...
                        className={cn(
                          ...
                          'bg-transparent text-[#c1ad8a] cursor-pointer',
                          'hover:bg-transparent hover:text-[#d7a742]',
                          'focus:bg-transparent focus:text-[#d7a742]',
                          isActive &&
                            'font-semibold bg-transparent text-[#d7a742]'
                        )}
                      >
                            ...
                            <li key={subItem.title}>
                              ...
                              >
                                ...
                                {subItem.external && (
                                  <ArrowUpRightIcon
                                    className={cn(
                                      'size-4 shrink-0 text-[#c1ad8a] items-center',
                                      'group-hover:bg-transparent group-hover:text-[#d7a742]',
                                      'group-focus:bg-transparent group-focus:text-[#d7a742]',
                                      isSubItemActive &&
                                        'bg-transparent text-[#d7a742]'
                  ...
                  <LocaleLink
                    ...
                    className={cn(
                      ...
                      'hover:bg-transparent hover:text-[#d7a742]',
                      'focus:bg-transparent focus:text-[#d7a742]',
                      isActive && 'font-semibold bg-transparent text-[#d7a742]'
                    )}
                    onClick={onLinkClicked}
                  >
        ...
        {/* bottom buttons */}
        <div className="flex w-full items-center justify-center gap-4 border-[#4a382a]/70 border-t p-4">
          <LocaleSelector />
        </div>
      </div>
    </div>
