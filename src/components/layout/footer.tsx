...
export function Footer({ className }: React.HTMLAttributes<HTMLElement>) {
  ...
  return (
    <footer
      className={cn(
        'border-[#4a382a] border-t bg-[#0d0a08] text-[#f6ead1]',
        className
      )}
    >
      ...
      <div className="border-[#4a382a] border-t py-8">
        <Container className="flex flex-col gap-3 px-4 md:flex-row md:items-center md:justify-between">
          ...
          <span className="text-muted-foreground text-sm">
            Independent guide hub. Not affiliated with Studio Hakubyousai,
            Atelier KUSOGE, Valve, Steam or YouTube.
          </span>
        </Container>
      </div>
    </footer>
