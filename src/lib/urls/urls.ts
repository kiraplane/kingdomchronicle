...
export const CANONICAL_BASE_URL = 'https://www.kingdomchronicle.wiki';
...
function getKingdomChronicleBaseUrl(url?: string) {
  ...
  try {
    ...
    if (
      parsedUrl.hostname === 'kingdomchronicle.wiki' ||
      parsedUrl.hostname === 'www.kingdomchronicle.wiki'
    ) {
...
export function getBaseUrl(): string {
  ...
  const kingdomchronicleBaseUrl = getKingdomChronicleBaseUrl(configuredBaseUrl);
  if (kingdomchronicleBaseUrl) {
    return kingdomchronicleBaseUrl;
  }
