...
const retiredPublicRouteRedirects: Array<{
  ...
  { pattern: /^\/combat(?:\/.*)?$/, target: '/guides/war-and-reinforcements' },
  {
    pattern: /^\/boss-order(?:\/.*)?$/,
    target: '/guides/campaigns-and-victory',
  },
  ...
  {
    pattern: /^\/kingdomchronicle-beginner-guide(?:\/.*)?$/,
    target: '/guides/beginner-guide',
  },
  {
    pattern: /^\/kingdomchronicle-map(?:\/.*)?$/,
    target: '/guides',
  },
  {
    pattern: /^\/kingdomchronicle-boss-order(?:\/.*)?$/,
    target: '/guides/campaigns-and-victory',
  },
  {
    pattern: /^\/kingdomchronicle-download(?:\/.*)?$/,
    target: '/download',
  },
];
...
export default async function middleware(req: NextRequest) {
  ...
  const productionHosts = new Set([
    'kingdomchronicle.wiki',
    'www.kingdomchronicle.wiki',
  ]);
  const canonicalHost = 'www.kingdomchronicle.wiki';
